...
#DO NOT do calculations in the print
...
print(
    ...
    + "Course: \"" + COURSE_NAME + "\"\n"
    + "Scores as strings: " + first_score_string + " + " + bonus_score_string + " = " + scores_as_strings + "\n"
    + "Scores as numbers: " + str(first_score_number) + " + " + str(scores_as_strings) + " = " + str(final_grade)
)
